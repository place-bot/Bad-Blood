...
\section*{7. Complete V1 error metrics}
V1: high-resolution two-channel residual 1D CNN, trained with standardized-target MSE. These metrics use saved predictions from the selected checkpoint; the weights are unchanged.
\subsection*{Official calibration-free test: 144 people / 57,600 segments}
{\small\renewcommand{\arraystretch}{1.05}

\par\smallskip
\begin{tabular}{@{}p{0.57\linewidth}p{0.17\linewidth}p{0.17\linewidth}@{}}\toprule
Metric & SBP & DBP\\\midrule
MAE & 12.46 & 8.46\\
Bias & -1.92 & -1.64\\
Error SD & 15.89 & 10.66\\
Within 5 mmHg (\%) & 26.06 & 37.24\\
Within 10 mmHg (\%) & 48.80 & 66.11\\
Within 15 mmHg (\%) & 67.55 & 84.62\\
Participant-macro MAE & 12.46 & 8.46\\
Participant MAE: median & 11.02 & 7.32\\
Participant MAE: 90th percentile & 20.80 & 14.35\\
\bottomrule\end{tabular}\par\smallskip
}
\subsection*{AAMI-designated subset: 116 people / 666 segments}
{\small\renewcommand{\arraystretch}{1.05}
...
MAE & 19.34 & 13.17\\
Bias & -12.74 & -9.31\\
Error SD & 22.72 & 13.93\\
Within 5 mmHg (\%) & 19.22 & 24.77\\
Within 10 mmHg (\%) & 36.19 & 45.20\\
Within 15 mmHg (\%) & 53.00 & 67.27\\
Participant-macro MAE & 19.58 & 13.10\\
Participant MAE: median & 15.95 & 11.46\\
Participant MAE: 90th percentile & 36.76 & 23.72\\
\bottomrule\end{tabular}\par\smallskip
}
Error is prediction minus reference; SD uses N-1. Errors are in mmHg except percentages. Thresholds are inclusive. Participant-macro MAE weights each person equally. These are source-data evaluations, not a clinical validation of a cuff device. Full validation and exposure-excluded metrics, plus each participant's MAE, are in the V1 reports folder.
\end{document}